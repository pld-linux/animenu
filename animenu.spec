...
Menu ekranowe obsługiwane pilotem. Jest w pełni konfigurowalne, z
możliwością konfiguracji wczytywanych podczas startu katalogów
i programów przypisanych do obsługi poszczególnych typów plików.
